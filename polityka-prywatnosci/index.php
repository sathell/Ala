...
<head>
    ...
    <title>Polityka prywatności — Alicja Muryn Ekspert Kredytowy Koszalin</title>
    <meta name="robots" content="noindex, follow">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500&family=Jost:wght@300;400;500&display=swap"
...
<body>
    <div class="page-wrap">
        ...
        <header class="page-header">
            ...
            <p class="subtitle">kredyty-koszalin.pl</p>
        </header>
        ...
        <div class="policy-body">
            ...
            <ol>
                <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>https://kredyty-koszalin.pl/</b></li>
                <li>
                    Operatorem serwisu oraz Administratorem danych osobowych jest: Alicja Muryn ul. Bolesława Krzywoustego, 75-064, Koszalin

                    6691841342
                </li>

                <li>Adres kontaktowy poczty elektronicznej operatora: alicja.muryn@outlook.com</li>
            ...
            <ol>
                ...
                <li>
                    Operator okresowo zmienia swoje hasła
                    administracyjne.
                </li>


                <li>
                    W celu minimalizacji ryzyka nieuprawnionego dostępu od danych, Operator
